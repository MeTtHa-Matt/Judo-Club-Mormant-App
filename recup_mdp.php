        ...
        <div class="container min-vh-100 d-flex justify-content-center align-items-center">
            <div class="card border-0 shadow-lg overflow-hidden judo-card"
                ...
                <div class="card-header card-header-judo text-white text-center py-4 border-0">
                    <h2 class="fw-bold mt-2 mb-0">Changer mon mot de passe</h2>
                </div>

                <div class="card-body p-4 p-sm-5 bg-white">
                    <form action="includes/account/change_password_process.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="text-center mt-3">
                            <p class="small text-secondary mb-0">Vous avez retrouvé votre mot de passe ? <a href="register.php"
