...
<body>
    <main class="container py-5">
        <div class="card border-0 shadow-sm rounded-4 p-5 text-center">
            <h1 class="display-6 fw-bold text-danger">Accès refusé</h1>
            <p class="lead mt-4">Votre compte est actuellement banni. Si vous pensez qu'il s'agit d'une erreur,
                contactez l'administration.</p>
