    ...
    <header class="hero-judo hero-judo-compact text-center d-flex align-items-center justify-content-center">
        ...
        <div class="container position-relative text-white py-5">
            <div class="hero-badge">
                <span class="badge-text"><i class="bi bi-apple me-2"></i>Installer sur iOS</span>
            </div>
            <h1 class="display-4 fw-bolder text-uppercase tracking-wider animate-fade-in hero-title">Tutoriel iPhone / iPad</h1>
            ...
            <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5 install-card">
                <div class="text-center mb-4">
                    <h2 class="h1 fw-bold text-uppercase position-relative d-inline-block section-title">
                        Installer sur <span class="text-judo-red">iOS</span>
                    </h2>
                    <p class="text-muted mt-3 mb-0 mx-auto install-intro">
                        Depuis Safari, ajoutez la page d’accueil du club à votre écran d’accueil pour l’utiliser comme une application mobile.
                    </p>
                </div>
